    ...
    var press = window.press = (function (pressId) {
        ...
        var initSlide = function(el){
            if(!slideList.hasOwnProperty(el.id)){
                addSlide(el); //add slide to slideList and slideNumberList with all of it's properties
            }
        ...
        var setClasses = function(el){
            ...
            el.element.classList.remove("state-unknown");

            el.next.element.classList.add("next");
            el.next.element.classList.remove("state-unknown");

            el.previous.element.classList.add("previous");
            el.previous.element.classList.remove("state-unknown");
        };
        ...
        var addNewSlide = function(el){
            ...
            currentSlide.element.parentNode.insertBefore(el, currentSlide.element); //adding to Dom
